...
?>
<html>
<head><title>Courses-Computer Science and Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<body>
  <div class ="header">
    <h1><center>COMPUTER SCIENCE ENGINEERING</center></h1>
...
<td><a href="course.php"><h2>Compiler Design (16CS62)</h2></a></td>
<td><a href="course.php"><h2>Computer Networks (16CS63)</h2></a></td>
</tr>
<tr>
<td><a href="course.php"><h2>Computer Architecture (16CS64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Mobile Computing (16CS6C1)</h2></option>
<option value="course.php"><h2>Web Programming (16CS6C2)</h2></option>
<option value="course.php"><h2>Cloud Computing (16CS6C3)</h2></option>
<option value="course.php"><h2>Network Programming (16CS6C4)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Fuzzy Logic and Intelligent Information Systems (16CS6D1)</h2></option>
<option value="course.php"><h2>Data Warehousing and Data Mining (16CS6D2)</h2></option>
<option value="course.php"><h2>Object Oriented Analysis and Design (16CS6D3)</h2></option>
<option value="course.php"><h2>Linux Internals (16CS6D4)</h2></option>
<option value="course.php"><h2>Introduction to Optimization Techniques (16CS6D5)</h2></option>
</td>
</tr>
<tr>
