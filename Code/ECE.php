...
?>
<html>
<head><title>Courses-Electronics and Communication Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<td><a href="course.php"><h2>Communication System II (16EC62)</h2></a></td>
<td><a href="course.php"><h2>Computer Communication Networks (16EC63)</h2></a></td>
</tr>
<tr>
<td><a href=""><h2>Analog and Mixed Signal IC Design (16EC64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Cryptography and Network Security (16EC6C1)</h2></option>
<option value="course.php"><h2>Real Time Embedded Systems (16EC6C2)</h2></option>
<option value="course.php"><h2>Image Processing (16EC6C3)</h2></option>
<option value="course.php"><h2>Low Power VLSI Design (16EC6C4)</h2></option>
<option value="course.php"><h2>Data Structure using C++ (16EC6C5)</h2></option>
<option value="course.php"><h2>System Programming and Software (16EC6C6)</h2></option>
<option value="course.php"><h2>Flexible Electronics (16EC6C7)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Optical Fiber Communication and Networks (16EC6D1)</h2></option>
<option value="course.php"><h2>ARM Cortex Processors (16EC6D2)</h2></option>
<option value="course.php"><h2>Adaptive Signal Processing (16EC6D3)</h2></option>
<option value="course.php"><h2>System verilog (16EC6D4)</h2></option>
<option value="course.php"><h2>Algorithm for VLSI Design Automation (16EC6D5)</h2></option>
<option value="course.php"><h2>Database Management Systems (16EC6D6)</h2></option>
<option value="course.php"><h2>Internet of Things (16EC6D7)</h2></option>
</td>
</tr>
<tr>
