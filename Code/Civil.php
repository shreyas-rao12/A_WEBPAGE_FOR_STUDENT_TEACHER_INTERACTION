...
?>
<html>
<head><title>Courses-Civil Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<td><a href="course.php"><h2>Geotechnical Engineering (16CV62)</h2></a></td>
<td><a href="course.php"><h2>Prestressed Concrete Structures (16CV63)</h2></a></td>
</tr>
<tr>
<td><a href="course.php"><h2>Transportation Engineering (16CV64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="course.php" disabled selected>Select your option</option>
<option value="course.php"><h2>Structural Masonry (16CV6C1)</h2></option>
<option value="course.php"><h2>Traffic Engineering and Transportation Planning (16CV6C2)</h2></option>
<option value="course.php"><h2>Air Pollution and Control Engineering (16CV6C3)</h2></option>
<option value="course.php"><h2>Watershed Management (16CV6C4)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="course.php" disabled selected>Select your option</option>
<option value="course.php"><h2>Structural Dynamics (16CV6D1)</h2></option>
<option value="course.php"><h2>Remote Sensing and GIS (16CV6D2)</h2></option>
<option value="course.php"><h2>Construction Management (16CV6D3)</h2></option>
<option value="course.php"><h2>Advanced Concrete Technology (16CV6D4)</h2></option>
</td>
</tr>
<tr>
