...
?>
<html>
<head><title>Courses-Chemical Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<body>
  <div class ="header">
    <h1><center>CHEMICAL ENGINEERING</center></h1>
...
<td><a href="course.php"><h2>Chemical Equipment Design and Drawing (16CH62)</h2></a></td>
<td><a href="course.php"><h2>Process Simulation and Modeling (16CH63)</h2></a></td>
</tr>
<tr>
<td><a href="course.php"><h2>Heterogenous Reaction Systems (16CH64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Nanofabrication (16CH6C1)</h2></option>
<option value="course.php"><h2>Fuel Cell Technology (16CH6C2)</h2></option>
<option value="course.php"><h2>Computational Methods for Chemical Engineers (16CH6C3)</h2></option>
<option value="course.php"><h2>Pilot Plant and Scale up studies (16CH6C4)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Biochemical Engineering (16CH6D1)</h2></option>
<option value="course.php"><h2>Pollution Control Engineering (16CH6D2)</h2></option>
<option value="course.php"><h2>Novel Seperation Techniques (16CH6D3)</h2></option>
<option value="course.php"><h2>Polymer Science and Technology (16CH6D4)</h2></option>
</td>
</tr>
<tr>
