...
?>
<html>
<head><title>Courses-Telecommunication Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<body>
  <div class ="header">
    <h1><center>TELECOMMUNICATION ENGINEERING</center></h1>
...
<td><a href="course.php"><h2>Computer Communication Networks (16TE62)</h2></a></td>
<td><a href="course.php"><h2>Information Theory and Coding (16TE63)</h2></a></td>
</tr>
<tr>
<td><a href=""><h2>Radiating Systems (16TE64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>CMOS Circuit Design (16TE6C1)</h2></option>
<option value="course.php"><h2>ARM Processor (16TE6C2)</h2></option>
<option value="course.php"><h2>Multimedia Communication (16TE6C3)</h2></option>
<option value="course.php"><h2>Operating Systems (16TE6C4)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Microwave Integrated Circuits (16TE6D1)</h2></option>
<option value="course.php"><h2>Digital Signal Processor Architecture (16TE6D2)</h2></option>
<option value="course.php"><h2>Cryptography and Network Security (16TE6D3)</h2></option>
<option value="course.php"><h2>JAVA (16TE6D4)</h2></option>
</td>
</tr>
<tr>
