...
?>
<html>
<head><title>Courses-Mechanical Engineering</title></head>
<style type="text/css">
@keyframes anim1{
...
<tr>
<td><a href="course.php"><h2>Intellectual Property Rights and Entrepreneurship  (16HSI61)</h2></a></td>
<td><a href="course.php"><h2>Design of Machine Elements II (16ME62)</h2></a></td>
<td><a href="course.php"><h2>Turbo Machinery (16ME63)</h2></a></td>
</tr>
<tr>
<td><a href=""><h2>Finite Element Methods (16ME64)</h2></a></td>
<td><h2>Elective - C</h2>
<select name="Elective-C" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Hydraulics and Pneumatics (16ME6C1)</h2></option>
<option value="course.php"><h2>Computational Fluid Dynamics (16ME6C2)</h2></option>
<option value="course.php"><h2>Energy Conversion Engineering (16ME6C3)</h2></option>
<option value="course.php"><h2>Advanced Machine Design (16ME6C4)</h2></option>
<option value="course.php"><h2>Product Design and Development (16ME6C5)</h2></option>
</td>
<td><h2>Elective - D</h2>
<select name="Elective-D" onchange="location=this.options[this.selectedIndex].value">
<option value="" disabled selected>Select your option</option>
<option value="course.php"><h2>Gas dynamics and Combustion (16ME6D1)</h2></option>
<option value="course.php"><h2>Non Traditional Processes (16ME6D2)</h2></option>
<option value="course.php"><h2>Theory of Plates and Shells (16ME6D3)</h2></option>
<option value="course.php"><h2>Cutting Tool Design (16ME6D4)</h2></option>
<option value="course.php"><h2>Quality Assurance (16ME6D5)</h2></option>
</td>
</tr>
<tr>
